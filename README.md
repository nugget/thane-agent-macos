...
- **Core identity evidence.** The native Server view surfaces Thane's stable instance ID, founding public-key fingerprints, signed birth and active core revisions, anchor posture, and separate admission/HEAD verification results without presenting them as a self-issued trust verdict.
